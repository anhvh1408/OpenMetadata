...
describe('Entity Summary Panel', () => {
  beforeEach(() => {
    ...
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*&index=table_search_index*',
      'getTableEntity'
    );
  ...
  it('Database', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=database_search_index*',
      'getDatabaseEntity'
    );
  ...
  it('Database schema', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=database_schema_search_index*',
  ...
  it('Dashboard entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=dashboard_search_index*',
      'getDashboardEntity'
    );
  ...
  it('Dashboard data model entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=dashboard_data_model_search_index*',
  ...
  it('Pipeline entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=pipeline_search_index*',
      'getPipelineEntity'
    );
  ...
  it('Topic entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=topic_search_index*',
      'getTopicEntity'
    );
  ...
  it('ML Model entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=mlmodel_search_index*',
      'getMLModelEntity'
    );
  ...
  it('Container entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=container_search_index*',
      'getContainerEntity'
    );
  ...
  it('Search Index entity', () => {
    interceptURL(
      'GET',
      '/audax/openmetadata/api/v1/search/query?*index=search_entity_search_index*',
