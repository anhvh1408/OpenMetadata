...
export const MOCK_DASHBOARD_DATA_MODEL: DashboardDataModel = {
  ...
  updatedBy: 'admin',
  href: 'http://localhost:8585/nexus/openmetadata/api/v1/dashboard/datamodels/0625e04d-3517-4bd9-98aa-086100198bf8',
  dataProducts: [],
  tags: [],
  deleted: false,
  followers: [],
  service: {
    ...
    deleted: false,
    href: 'http://localhost:8585/nexus/openmetadata/api/v1/services/dashboardServices/39f8eaf5-b211-4c36-bab6-7f11cf5ca624',
  },
